      ...
      <Container>
        <Row className='mb-4'>
            <div className='title flex-title'>
                ...
                <a href="../pdf/photography-inter.pdf" target="_blank"><Button><FaDownload/> Download Design Brief</Button></a>
            </div>
           <Col md={6} lg={6}>
        ...
        <Row className='mb-4'>
            <div className="rules__section">
               ...
               <ul>
                 ...
                 <li>Ensure that the image is not edited in any manner</li>
        ...
        <Row className='mb-4'>
            <div className='submit__section'>
                <h4>HOW TO SUBMIT</h4>
                <ul>
                    <li>Read all the competition rules and details giving above</li>
                    <li>Standard entry fees 300 rs</li>
